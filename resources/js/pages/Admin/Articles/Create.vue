        ...
        <div class="bg-white shadow-sm rounded-lg">
            <form @submit.prevent="submit" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="reading_time" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div v-if="form.errors.reading_time" class="text-red-600 text-sm mt-1">{{ form.errors.reading_time }}</div>
                    </div>
                </div>
                ...
                <div>
                    <label class="flex items-center">
                        <input v-model="form.is_published" 
                               type="checkbox" 
                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Publish article immediately</span>
                    </label>
                    <p class="text-sm text-gray-500 mt-1">If unchecked, the article will be saved as a draft.</p>
                </div>
